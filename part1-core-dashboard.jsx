        ...
        {quickView && (() => {
          ...
          <ResizablePanel
            ...
            <div style={{ display:'flex', gap:'8px', padding:'8px 14px', background:'#f8fafc', borderBottom:'1px solid var(--bd1)', flexShrink:0 }}>
              <button className="hr-btn" onClick={()=>{setQuickView(null); onEdit(qv);}} style={{ background:'#1a5fa8', color:'#fff', border:'none', padding:'6px 14px', borderRadius:'8px', fontSize:'14px', fontWeight:700, cursor:'pointer' }}>Edit Employee</button>
